...
const SharePopUp = ({ setClickOnShare }: IProps) => {
  ...
  const mailurl =
    'mailto:?subject=Check%20out%20my%20Personalized%20Capsule%20Wardrobe!&body=Capsule%20Wardrobe:%20' +
    url;

  return (
    <div className="ba bg-black-10 mw-100-m pa2 br4 tc mt3">
      <div className="p2">
        <div className="mb2 flx content-end">
          <span
            className="mt0 f1 pointer:hover"
            onClick={() => setClickOnShare(false)}
          >
            &times;{' '}
          </span>
        </div>
