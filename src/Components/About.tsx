  ...
  return (
    <div className="container flex flex-row flex-wrap justify-around mw9 content-center center ph4-ns">
      <div className="box ba bg-black-20 tc w-100 w-100-l br4 pa4 ma2">
        ...
        <p className="fw4 tl ">
          A capsule wardrobe is “a mini wardrobe made up of really versatile
          pieces that you totally love to wear.” Each season, you clear your
          closet except for a set number of pieces to be in your capsule
          wardrobe. Your capsule collection is made up of a combination of items
          you already own and love to wear, as well as new, quality items that
          you can shop for once a season.
        </p>
      </div>
    </div>
  );
