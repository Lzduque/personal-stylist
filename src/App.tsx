...
const App = () => {
  const [appStyle, setAppStyle] = useState<CSSProperties | undefined>({
    backgroundImage:
      'linear-gradient(-225deg, #fff 0%, #fff 29%, #fff 67%, #fff 100%)'
  });
        ...
        <ul className="icons list mb1 pl1">
          <li className="pb1">
            <a href="https://github.com/Lzduque">
              <i className="fab fa-github-alt fa-1x white ph2"></i>
            </a>{' '}
            Lzduque
          </li>
          <li className="pb1">
            <i className="fas fa-phone-alt fa-1x ph2"></i> 647.862.8984
          </li>
          <li className="pb1">
            <a href="https://www.linkedin.com/in/leticia-zamolo-duque-0266a233/">
              <i className="fab fa-linkedin fa-1x white ph2"></i>
            </a>{' '}
            Leticia Zamolo Duque
          </li>
          <li>
            <i className="fas fa-paper-plane fa-1x ph2"></i> lzduque@hotmail.com
          </li>
        </ul>
      </footer>
    </div>
